"""Rebuilds green_eggs_real_flight.csv from the raw EasyMini export
(green_eggs_real_flight_raw.csv), documenting every correction applied to
...
Reads data/green_eggs_real_flight_raw.csv, writes data/green_eggs_real_flight.csv.
"""
...
RAW_PATH = Path(__file__).parent / "green_eggs_real_flight_raw.csv"
OUT_PATH = Path(__file__).parent / "green_eggs_real_flight.csv"
