...
# (src/numericalrocketry/motors/estes_c11.eng header: "C11 24 70 0-3-5-7 0.012 0.0353 Estes").
# ==========================================
...
[7] Estes Industries. RASP .eng motor file for the C11, NAR-certified static-test
    data (src/numericalrocketry/motors/estes_c11.eng, this repository). Originally
