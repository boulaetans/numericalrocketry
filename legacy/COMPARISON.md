...
* **The 1D model's RK4 apogee (99.27 m) is within ~2% of the full 6DOF project's (101.25 m)** despite having no attitude dynamics, no exact Barrowman CP/stability treatment, and a simplified drag model — a reasonable showing for a model this much simpler, and a concrete sense of what the rest of this project's added fidelity is actually buying: the last ~2%, plus everything the 1D model can't represent at all (stability margin, off-axis motion, recovery).
